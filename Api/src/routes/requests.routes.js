...
import { DeletePostulation, addRequest, deleteRequest, getRequest, getRequests, getRequestsUser, getRequestsUserAcepted, updateRequest } from "../controllers/requests.controller.js";
...
router.put("/update-request/:id",requiredAuth, updateRequest)
